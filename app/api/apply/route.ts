  ...
  try {
    ...
    if (data.membershipType === 'full_member') {
      ...
      if (!addressValidation.valid) {
        const errorMsg = addressValidation.error === 'address_not_found' 
          ? 'We couldn\'t find that address. Please check the spelling and try again.'
          : addressValidation.error === 'not_riverhead'
          ? 'This address doesn\'t appear to be in Riverhead. Full membership is for Riverhead residents only. You can apply as a Friend of Riverhead instead.'
