    ...
    <div className="min-h-screen bg-gray-50 flex items-center justify-center p-8">
      <div className="max-w-md w-full bg-white rounded-lg p-8 text-center">
        ...
        <div className="bg-yellow-50 border-2 border-yellow-300 rounded-lg p-6 mb-6 text-left">
          <p className="text-lg font-bold text-yellow-800 mb-3">📧 Important - Check Your Email</p>
          <p className="text-yellow-800 mb-2">
            We&apos;ve sent you a welcome email with a link to set up your password.
          </p>
          <p className="text-yellow-800 font-semibold">
            ⚠️ It may be in your Junk or Spam folder - please check there too!
          </p>
          <p className="text-sm text-yellow-700 mt-3">
            Look for an email from <span className="font-medium">noreply@riverheadcommunity.org.nz</span>
          </p>
        </div>
